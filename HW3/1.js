...
const Сelsius = + prompt('Введите температуру в градусах Цельсия:');
const Fahrenheit = Math.round(((9 / 5) * Сelsius + 32) * 100) / 100;
alert(`Цельсий: ${Сelsius} \xB0C, Фаренгейт: ${Fahrenheit} \xB0F.`);